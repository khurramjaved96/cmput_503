...
class RectifierNode(DTROS):
    def __init__(self, node_name):
        ...
        self.sub_img = rospy.Subscriber(
            "/csc22938/camera_node/image/compressed", CompressedImage, self.cb_image, queue_size=1, buff_size="10MB"
        )
        self.sub_camera_info = rospy.Subscriber(
            "/csc22938/camera_node/camera_info", CameraInfo, self.cb_camera_info, queue_size=1
        )
    ...
    def cb_image(self, msg):
        ...
        dist_img = img = self.bridge.compressed_imgmsg_to_cv2(msg)
