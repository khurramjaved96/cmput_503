...
class PIDController:
    ...
    def control(self, error):
        ...
        # self.log("Delta_time " + str(delta_time))
        # self.log("KI term " + str(self.error_sum))
        ...
        return output, self.error_sum, (delta_error / delta_time), delta_time
...
class LaneFollowingNode(DTROS):
    def __init__(self, node_name):
        ...
        self.v_controller = PIDController(Kp=0.01, Ki=0.01, Kd=0.01)
    ...
    def process_image(self, msg):
        ...
        # img_2 = cv2.warpPerspective(img, transformation, (img.shape[1], img.shape[0]))
        ...
        output, ki_term, kd_term, delta_time = self.v_controller.control(error)
        self.log("ki_term = " + str(ki_term))
        self.log("kd_term = " + str(kd_term))
        self.log("Sum = " + str(output))
        self.log("Delta time = " + str(delta_time))
        # self.target_v = UP[0]
        # self.target_omega = error
